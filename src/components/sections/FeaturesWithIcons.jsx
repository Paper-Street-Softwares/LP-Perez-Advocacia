...
export default function FeaturesWithIcons({ colorMode }) {
  ...
  return (
    <SectionArea id="service" className={`${bgClass}`} paddingbot={true}>
      ...
      />
      <SectionWrapper>
        <div className="flex flex-col items-start w-full tablet1:flex-row tablet1:justify-between desktop1:gap-x-0 desktop1:px-0 bg-yellow-400">
          <div className="col1 tablet1:w-[50%] desktop1:w-[28%] flex flex-col justify-center items-center bg-red-900">
            <MotionDivDownToUp>
              <IconFeatureCard
          ...
          <MotionDivDownToUp className="hidden desktop1:flex justify-center w-[35%] ">
            <img
              ...
              className="hidden h-[640px] desktop1:h-[640px] object-cover w-full desktop1:flex col2 rounded-2xl bg-top bg-cover shadow-custom-opacity shadow-shadowFeatures/10"
              loading="lazy"
            />
          </MotionDivDownToUp>

          <div className="col3 tablet1:w-[50%] desktop1:w-[28%] flex flex-col justify-between items-center bg-green-900">
